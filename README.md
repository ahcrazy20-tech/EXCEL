...
- **مكان إدخال المفتاح:** الإعدادات → *مزوّد الذكاء الاصطناعي* → اختر المزوّد → الصق المفتاح → **اختبار** (يعرض ✓ وزمن الاستجابة أو رسالة الخطأ بالتفصيل) → **حفظ** / **اجعله المزوّد الأساسي**.
